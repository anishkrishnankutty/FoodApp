...
export default class CardDonor extends Component {
  ...
  render() {
    return (
      <TouchableOpacity style={{ width: this.props.itemWidth, marginBottom: 15, paddingLeft: 5, paddingRight: 5 }} onPress={()=>this.props.navigation.navigate("DonorDetail", this.props.object)}>
